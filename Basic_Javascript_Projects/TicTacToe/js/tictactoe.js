...
function  placeXorO(squareNumber)  {
    ...
    // The  .some() method is  used to check the each element  of the selectedSquare Array
    ...
    if (!selectedSquares.some(element  => element.includes(squareNumber)))  {
        ...
        // Returning true  is needed for our computersTurn() function to workd
        return true;    
    }
    // This function results in a ranmdom square being selected by the computer
    function computersTurn() {
        ...
        while (!success) {
            // A random number bertween 0 and 8 is selected
...
// drawlin() function is called to draw a lin on the screen  if the condition is m et
...
function disableClick() {
    ...
    // This makes aour body clickable  again after 1 second.
